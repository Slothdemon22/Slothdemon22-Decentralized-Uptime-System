...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Sending API POST request to login
    try {
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-zinc-900 border-white/10">
          <CardHeader className="text-center space-y-1">
            ...
            <CardDescription className="text-white/80">Sign in to access your monitoring dashboard</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="remember" className="h-4 w-4 rounded border-white/20 bg-zinc-800" />
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full bg-white text-black hover:bg-white/90 flex items-center justify-center gap-2 h-11"
            >
            ...
            <div className="space-y-3">
              {[{ title: "Global Monitoring", description: "Monitor your website from multiple locations worldwide" }, { title: "Real-time Alerts", description: "Get instant notifications when your website goes down" }, { title: "Comprehensive Analytics", description: "Detailed insights into your website's performance" }].map((feature, index) => (
